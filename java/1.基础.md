...
### 12. 为什么重写 equals 方法必须重写 hashcode 方法  
...
### 13. String s1 = new String("abc") 在内存中创建了几个对象  
...
#### 14.1 SOLID原则是面向对象设计和编程中的一组基本原则，其中SOLID分别是以下五个原则的首字母缩写：
